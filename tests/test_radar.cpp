...
void test_radar_equation() {
    ...
    // SNR should be reasonable for these parameters
    ...
    // Doubling range should reduce SNR by ~12 dB (R^4)
...
void test_antenna() {
    ...
    // 3dB beamwidth: gain at half_bw should be ~27 dB
...
void test_propagation() {
    ...
    // Free space path loss increases with range and frequency
...
void test_clutter() {
    ...
    // Sigma0 increases with grazing angle
    ...
    // MTI improvement should be positive
